...
% Aero Analysis
Configuration_filename= "ProjectNMNAL.xlsx"; % Design Input Excel Sheets

% Sizing Analysis
W_crew = 0; %lb
W_pay_drop = 4*2.205; %lb
W_pay_fixed = (25-4)*2.205; %lb
W0_guess= 25*2.205; % lb
config_row=2; %Geometric definition row number not including header (in design configuration spreadsheet file)
MissionProfile_filename="Mission_Profile_ProjectNMNAL.xlsx"; % YOUR MISSION PROFILE EXCELL
sheetnumber=2; %Mission profile sheet number (Mission_Profile_Template.xlsx)
ProfileName="Test Case 1";
writeFlag=true;
displayFlag=true;% flag for displaying additional iteration and segment data

% Point Performance
Requirements_filename="Requirements_Input_ProjectNMNAL.xlsx";
sheetnumber_req=2;
RequirementName="Test Case 1";
